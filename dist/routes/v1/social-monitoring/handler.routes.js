...
// ─── Routes ───────────────────────────────────────────────────────
export default async function handlerRoutes(fastify) {
    // ── POST /api/v1/projects/:projectId/social-handlers ──────────
    fastify.post("/api/v1/projects/:projectId/social-handlers", {
        schema: {
    ...
    fastify.get("/api/v1/projects/:projectId/social-handlers", {
        schema: {
            tags: ["Social Monitoring"],
    ...
    fastify.post("/api/v1/projects/:projectId/social-handlers/:handlerId/validate", {
        schema: {
            tags: ["Social Monitoring"],
    ...
    fastify.delete("/api/v1/projects/:projectId/social-handlers/:handlerId", {
        schema: {
            tags: ["Social Monitoring"],
