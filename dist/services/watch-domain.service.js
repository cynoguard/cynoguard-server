 ...
 */
export async function createWatchDomain(tenantId, userId, input) {
    ...
    const storedCount = await generateAndStoreCandidates(watchDomain.id, domain, watchDomain.tldAllowlist, watchDomain.tldSuspicious, watchDomain.tldStrategy, candidateCount);
    return {
        watchDomain: {
            id: watchDomain.id,
 ...
 */
export async function listWatchDomains(tenantId) {
