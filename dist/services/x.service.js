...
function getClient(encryptedToken) {
...
export async function validateBearerToken(encryptedToken) {
    try {
        ...
        if (msg.includes("429"))
            return { isValid: true }; // rate-limited but valid
 ...
 */
export async function fetchMentions(encryptedToken, keywords, maxResults = 50) {
