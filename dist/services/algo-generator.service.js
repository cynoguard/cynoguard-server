 ...
 */
export function generateAlgoCandidates(watchDomain, tlds, limit = 50) {
 ...
 */
export function buildTldList(watchDomain, tldAllowlist, tldSuspicious, strategy) {
    const watchTld = getTld(watchDomain);
    const tlds = new Set([watchTld]);
    // Add allowlist TLDs
