...
export async function getWatchlistEntry(prisma, watchlistId, projectId) {
...
export async function deleteWatchlistEntry(prisma, watchlistId, projectId) {
    return prisma.watchlistEntry.deleteMany({
        where: { id: watchlistId, projectId },
    });
}
export async function triggerScan(prisma, watchlistId, projectId) {
...
// ─── Candidates ───────────────────────────────────────────────────────────────
export async function listCandidates(prisma, watchlistId, projectId) {
...
export async function addManualCandidates(prisma, watchlistId, projectId, domains) {
    const entry = await prisma.watchlistEntry.findFirst({
        where: { id: watchlistId, projectId },
        select: { id: true },
    });
...
// ─── Scan logs ────────────────────────────────────────────────────────────────
export async function listScanLogs(prisma, watchlistId, projectId) {
    const entry = await prisma.watchlistEntry.findFirst({
        where: { id: watchlistId, projectId },
        select: { id: true },
    });
